...
import Courriel from './components/AdminMinistere/Courriel';
...
import MainContent from './components/AdminMinistere/MainContent';
...
import ChapterDetail from './components/Apprenant/Detailchapiter';
...
const App = () => {
  ...
  const routes = [
    ...
    { path: '/Courriel', element: <Courriel /> },
    ...
    { path: '/ListCours/Quizz/:QuizzId/QuestionList', element: <QuestionList /> },
    { path: '/ListChapitres/Quizz/:QuizzId/QuestionsChapitre', element: <QuestionsChapitre /> },
   ...
   { path: '/course/:coursId/chapter/:chapterId' , element:<ChapterDetail />} ,
...
<div>
      ...
      <div className="flex-1 w-full p-4 pt-16 pr-20 overflow-y-auto mr-0">
      <Routes>
