    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="w-full flex flex-col">
        ...
        <Dialog open={openCoursDialog} onClose={() => setOpenCoursDialog(false)}>
          ...
          <DialogContent>
            <TextField label="title" fullWidth value={currentCours?.title} onChange={(e) => setCurrentCours({ ...currentCours, title: e.target.value })} margin="normal" />
            <TextField label="description" fullWidth value={currentCours?.description} onChange={(e) => setCurrentCours({ ...currentCours, description: e.target.value })} margin="normal" />
            <TextField label="logo" fullWidth value={currentCours?.logo} onChange={(e) => setCurrentCours({ ...currentCours, logo: e.target.value })} margin="normal" />
            <TextField label="Grade (ID)" fullWidth type="number" value={currentCours?.grades} onChange={(e) => setCurrentCours({ ...currentCours, grades: +e.target.value })} margin="normal" />
          </DialogContent>
          <DialogActions>
