...
function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Pass reCAPTCHA token to the backend
      const response = await authService.login(email, password, recaptchaToken) as AuthResponse;
      ...
      if ((error as any).response?.status === 403) {
        ...
        setError('Identifiants incorrects ou erreur de vérification reCAPTCHA.');
      }
    }
  };

  return (
    <div className="min-h-screen flex  p-0 m-0">
      ...
      <div className="w-full lg:w-1/2 p-8 sm:p-12 xl:p-24 flex flex-col justify-between overflow-auto bg-white">
        <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <ReCAPTCHA
                sitekey="6LfVMhwrAAAAAPUntJDVkAvsbOp9O8I_E5Tx_b5o" // Replace with your Site Key
