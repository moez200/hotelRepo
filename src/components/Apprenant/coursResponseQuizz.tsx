...
import { Chapitre, CourseQuizResponse, CourType, QuizResponse } from '../../types/auth';
...
function QuizCourResponsesList() {
  ...
  const [quizResponses, setQuizResponses] = useState<CourseQuizResponse[]>([]);
  ...
  const fetchQuizResponses = async () => {
    try {
      ...
      const responses = await quizService.getCourseQuizResponses( courseIdNum);
      ...
      <div className="w-full flex flex-col mr-64">
        ...
        <div className="mb-8 flex justify-between items-center">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Gestion des Réponses aux Quiz Cour</h1>
          </div>
...
export default QuizCourResponsesList;